...
do
...

    {
      ...
      echo "warning: DO NOT CHANGE THIS MANUALLY, THIS IS GENERATED BY https://github.com/duckdb/community-extensions repository, check README there" >> $EXTENSION_README
      ...
      rm -rf $DOCS/$extension.db
        ...
        echo "Failed processing $extension, skipping"
        rm -f $EXTENSION_README
    }
done
